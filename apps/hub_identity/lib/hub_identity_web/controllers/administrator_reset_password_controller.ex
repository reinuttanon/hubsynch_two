defmodule HubIdentityWeb.AdministratorResetPasswordController do
  @moduledoc false
  ...
  def edit(conn, _params) do
    render(conn, "edit.html",
      changeset: Administration.change_administrator_password(conn.assigns.administrator)
    )
  end
  ...
  def update(conn, %{"administrator" => administrator_params}) do
    case Administration.reset_administrator_password(
           conn.assigns.administrator,
