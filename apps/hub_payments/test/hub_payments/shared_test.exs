defmodule HubPayments.SharedTest do
  ...
  describe "settings" do
    ...
    test "create_setting/1 with valid enviroment data returns succeed" do
      ...
      assert error_changeset.errors[:env] ==
               {"is invalid",
                [validation: :inclusion, enum: ["development", "production", "staging"]]}
    end
    ...
    test "create_setting/1 with valid type data returns succeed" do
      ...
      assert error_changeset.errors[:type] ==
               {"is invalid",
                [validation: :inclusion, enum: ["secret", "file_path", "url", "setting"]]}
    end
